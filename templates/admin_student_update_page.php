...
<?php
    ...
    if (isset($_POST['student_update_submit'])) {
        ...
        if ($password_1 == $password_2){
            $sql_update= "UPDATE user_account SET `first name`='".$first_name."',`father name`='".$last_name."',phone_number='".$phonenumber."',email='".$email."',password='".$password_1."',student_jd='".$schoold_id."',user_name='".$username."' WHERE student_jd='".$schoold_id."'";
            $sql_update2 = "UPDATE student_information SET enrolled_departement='".$departement."',student_id='".$schoold_id."' WHERE student_id='".$schoold_id."'";
                            ...
                            <div class="col">
                                <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input type="text"  name="schoold_id" class="form-control" id="formGroupExampleInput" value="<?php echo $rows['student_jd'] ?>">
                                        </div>
                                        <br>
