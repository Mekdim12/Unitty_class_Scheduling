...
<?php
    ...
    if (isset($_POST['delete_button'])){
        ...
        $sql = "DELETE FROM user_account WHERE student_jd='".$teacher_id."'";
        $sql2 = "DELETE FROM teacher_information WHERE teacher_id='".$teacher_id."'";
        try{
    ...
    if (isset($_POST['teacher_info_submit'])) {
        ...
        $sql = "INSERT INTO `user_account`(`first name`, `father name`, `phone_number`, `email`, `password`, `student_jd`, `account_type`, `user_name`) VALUES ('$first_name', '$last_name', '$phonenumber', '$email', '$password_1', '$employe_id', 'Teacher', '$username') ";
        $sql2 = "INSERT INTO `teacher_information`(`department`, `teacher_id`) VALUES ('$departement','$employe_id')";
        try{
            $result = mysqlexec($sql);
                        ...
                        <!-- Insert Course -->
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Register Teacher Information </h5>
                                ...
                                <div class="modal-body">
                                    <form action="" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="employe_id">Employee id number</label>
                                                <input type="text"  name="employe_id" class="form-control" id="formGroupExampleInput" placeholder="Employe Id">
                                            </div>
                                            <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email"  name="email" class="form-control" id="formGroupExampleInput" placeholder="teacher@example.com">
                                            </div>
                                            <br>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="teacher_info_submit"  class="btn btn-success">Save</button>
                                            </div>
                                            ...
                                            if ($result_1) {
                                               $row_counter = 1;
                                                ...
                                                foreach($result_1 as $values1){
                                                  ...
                                                  $teacher_id = $values1['student_jd'];
                                                  $full_name =$values1['first name']." ".$values1['father name'];
                                                  $email = $values1['email'];
                                                  $phonenumber = $values1['phone_number'];
                                                  
                                                
                                                  $sql22 =  "SELECT * FROM teacher_information WHERE teacher_id='$teacher_id'";
                                                      ...
                                                      foreach($result_2 as $values_){
                                                        ...
                                                        echo '
                                                            <tr> 
                                                                ...
                                                                <td>'.$full_name.' </td>
                                                                <td>'.$values_['department'].' </td>
                                                                <td>'.$email.'</td>
                                                                <td>'.$phonenumber.'</td>
                                                                <td>
                                                                    <a href="admin_teacher_update_page.php?empl_id='.$values_["teacher_id"].' ">
                                                                        <button class="btn btn-success"> Update </button> 
                                                                    </a>
                                                                </td>
                                                                <td> <form method="POST" action=""><input  name="student_id" type="hidden" value="'.$values_['teacher_id'].'"><input type="submit" class="btn btn-danger" name="delete_button" value="Delete"></form> </td>
                                                            </tr>
